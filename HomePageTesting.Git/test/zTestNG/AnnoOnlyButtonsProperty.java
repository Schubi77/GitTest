...
public class AnnoOnlyButtonsProperty
{
	...
	static String propertiesFilePath = System.getProperty("user.dir") + "\\testData.properties";
	...
	public void getParameter()
	{
		...
		try
		{
			OutputStream propertiesFileWriter = new FileOutputStream(propertiesFilePath);
